  ...
  return (
    <section className="bg-white rounded-xl shadow-xs border border-slate-200 p-5 space-y-5">
      <div className="border-b border-slate-100 pb-3 flex items-center justify-between">
        ...
        <span className="text-xs text-slate-500 font-medium">Cover Page & Valuation Context</span>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {/* Report Date */}
        <div>
          <label htmlFor="reportDate" className="block text-xs font-semibold text-slate-700 mb-1">
        ...
        {/* Client */}
        <div>
          <label htmlFor="client" className="block text-xs font-semibold text-slate-700 mb-1">
        ...
        {/* Contractor */}
        <div>
          <label htmlFor="contractor" className="block text-xs font-semibold text-slate-700 mb-1">
        ...
        {/* PO Number */}
        <div>
          <label htmlFor="poNumber" className="block text-xs font-semibold text-slate-700 mb-1">
        ...
        {/* Project Start Date */}
        <div>
          <label htmlFor="projectStartDate" className="block text-xs font-semibold text-slate-700 mb-1">
        ...
        {/* Project End Date */}
        <div>
          <label htmlFor="projectEndDate" className="block text-xs font-semibold text-slate-700 mb-1">
            Project End Date <span className="text-rose-500">*</span>
          </label>
          <input
            id="projectEndDate"
            type="date"
        ...
        {/* Project Leader */}
        <div>
          <label htmlFor="projectLeader" className="block text-xs font-semibold text-slate-700 mb-1">
            Project Leader <span className="text-rose-500">*</span>
          </label>
          <input
            id="projectLeader"
            type="text"
        ...
        <div className="sm:col-span-2">
          <label htmlFor="projectAmount" className="block text-xs font-semibold text-slate-700 mb-1">
            Project Amount (Authoritative Contract Value) <span className="text-rose-500">*</span>
          </label>
          <div className="relative flex rounded-lg shadow-2xs">
            ...
            />
            <span className="inline-flex items-center px-3 rounded-r-lg border border-l-0 border-slate-300 bg-slate-50 text-slate-600 text-xs font-semibold">
              {currency}
            </span>
          </div>
          {errors.projectAmount && (
        ...
        <div>
          ...
          <select
            id="currency"
            {...register('currency')}
            className="w-full rounded-lg text-xs py-2 px-3 border border-slate-300 bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100 focus:outline-none"
          >
      ...
      {/* Calculated Read-Only Metrics Preview Cards */}
      <div className="pt-3 border-t border-slate-100">
        <div className="text-xs font-semibold text-slate-500 mb-2.5 flex items-center space-x-1.5">
          <Clock className="w-3.5 h-3.5" />
          <span>Automatically Computed Project Timeline & Valuation</span>
        </div>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          {/* Day Number */}
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-3">
            <div className="text-[11px] text-slate-500 font-medium">Day Number</div>
            <div className={`text-sm font-bold mt-0.5 ${
              calculations.dayNumberStatus === 'past_due' ? 'text-amber-600' : 'text-slate-900'
            }`}>
          ...
          <div className="bg-blue-50/70 border border-blue-200 rounded-lg p-3">
            <div className="text-[11px] text-blue-700 font-medium">Overall Net Progress</div>
          ...
          <div className="bg-blue-50/70 border border-blue-200 rounded-lg p-3">
            <div className="text-[11px] text-blue-700 font-medium">Earned Progress Value</div>
            <div className="text-sm font-bold text-blue-900 mt-0.5 truncate" title={formatCurrency(calculations.totalProgressValue, currency)}>
